...
if (DEFINED GROMACS_SUFFIX AND NOT "${GROMACS_SUFFIX}" STREQUAL "_mpi")
    message(FATAL_ERROR "GROMACS_SUFFIX is set inconsistently, expected '_mpi'")
endif()
set(GROMACS_SUFFIX "_mpi")
set(GROMACS_CXX_COMPILER "/usr/bin/x86_64-linux-gnu-g++-9")
set(GROMACS_CXX_COMPILER_ID "GNU")
set(GROMACS_CXX_COMPILER_VERSION "9.3.0")
set(GROMACS_CXX_FLAGS "-std=c++0x ")
